...
module.exports.routes = {
	...
	'/api/ticket/findServiceTickets': {		
		controller: 'ticket',
		action: 'findServiceTickets'
	},

	'/api/contact/authenticate': {		
		controller: 'contact',
		action: 'authenticate'
	},
	...
	'/api/member/isValidMemberIdAndPassword': {		
		controller: 'member',
		action: 'isValidMemberIdAndPassword'
	},

	'/api/member/findMembers': {		
		controller: 'member',
		action: 'findMembers'
	}
